...
w1g2.org 是使用 WireGuard 开源技术的公益翻墙 VPN。为了抗墙，这里的本网链接都是域名的数字地址而不是平常的域名地址。
...
* 手机系统可以扫描通信码，也可以下载导入通信码上面的 zip 文件
...
<br/><br/>
如果一个机器符合下列任何一种情况，这个机器当天就只能用到 __1000(MB)__：<br/>
  - “上传流量”超过 200 (MB)<br/>
  - “最大流速”超过 200 (MBpm)（等于1分钟内流量消耗了200MB）<br/>
<br/>
